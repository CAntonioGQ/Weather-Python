...
class Ventana(Frame):
    def __init__(self, master, *args):
        ...
        self.frame5.grid(column=0, row = 1, sticky='nsew', padx=5, pady=5)
        self.frame6 = Frame(self.master, bg='aquamarine', highlightbackground='dark violet', highlightthickness=2)
        self.frame6.grid(column=1, row = 1, sticky='nsew', padx=5, pady=5)
        self.frame7 = Frame(self.master, bg='skyblue', highlightbackground='dark violet', highlightthickness=2)
        self.frame7.grid(column=2, row = 1, sticky='nsew', padx=5, pady=5)
    ...
    def animacion(self):
        ...
        if self.click == True:
            for i in range(1, frames):
                self.inicio = PhotoImage(file='buscar.gif', formar='gif -index %i' %(i))
    ...
    def obtener_tiempo(self):
        ...
        API = 'https://api.openweathermap.org/data/2.5/weather?q=' + ciudad + '&appid=ba6c6680da60816d1f12e47fea94b31e'
    ...
    def widgets(self):
        self.inicio = PhotoImage(file='C:\\Users\\User\\Documents\\Portafolio\\WeatherPython\\buscar.gif')
        self.imagen_temp = PhotoImage(file='C:\\Users\\User\\Documents\\Portafolio\\WeatherPython\\temperatura.png')
        self.imagen_temp_min = PhotoImage(file='C:\\Users\\User\\Documents\\Portafolio\\WeatherPython\\temp_min.png')
        self.imagen_temp_max = PhotoImage(file='C:\\Users\\User\\Documents\\Portafolio\\WeatherPython\\temp_max.png')
        self.imagen_humedad = PhotoImage(file='C:\\Users\\User\\Documents\\Portafolio\\WeatherPython\\humedad.png')
        self.imagen_viento = PhotoImage(file='C:\\Users\\User\\Documents\\Portafolio\\WeatherPython\\viento.png')
        self.imagen_presion = PhotoImage(file='C:\\Users\\User\\Documents\\Portafolio\\WeatherPython\\presion.png')
        ...
        self.ingresa_ciudad = Entry(self.frame, font=('Comic Sans MS', 12),
                                    highlightbackground="DarkOrchid1", highlightcolor="green2", highlightthickness=2)
...
if __name__ == "__main__":
    ...
    ventana.call('wm', 'iconphoto', ventana._w, PhotoImage(file='C:\\Users\\User\\Documents\\Portafolio\\WeatherPython\\temperatura.png'))
